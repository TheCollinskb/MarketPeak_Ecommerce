...
This is a **fully deployed, responsive ecommerce website** using the **Eco Lume Boostrapped Template** (currently used as a placeholder for MarketPeak Ecommerce).  
...
|------------------|-------------------------------------|
| Cloud Provider   | AWS EC2 (t2.micro or similar)       |
...
sudo git clone https://github.com/Thecollinskb/MarketPeak_Ecommerce.git /var/www/html/
...
# Get public IP
curl -s http://3.81.229.99/latest/meta-data/public-ipv4
```
...
You should see:  
> **Eco Lume - Free Bootstrap 5 HTML Template**
...
sudo certbot --apache -d $(curl -s http://3.81.229.99/latest/meta-data/public-ipv4)
```
